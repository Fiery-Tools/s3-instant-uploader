  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6 font-sans text-slate-800">
      ...
      <div className="absolute top-5 right-5">
        <a href="https://github.com/aws/aws-sdk-js-v3" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-slate-800 transition-colors flex items-center gap-2 text-sm font-medium">
          <span>Source</span>
